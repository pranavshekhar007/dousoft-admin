  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<ProductManufactureLocactionList />}
      />
      ...
      <Route
        path="/update-product-step1/:id"
        element={<ProductUpdateStep1 />}
      />
      <Route
        path="/update-product-step2/:id"
        element={<ProductUpdateStep2 />}
      />
      <Route
        path="/update-product-step3/:id"
        element={<ProductUpdateStep3 />}
      />
      <Route
        path="/update-product-attributes/:id"
        element={<ProductUpdateAttribute />}
      />
      ...
      <Route
        path="/update-combo-product-step1/:id"
        element={<ComboProductUpdateStep1 />}
      />
      <Route
        path="/update-combo-product-step2/:id"
        element={<ComboProductUpdateStep2 />}
      />
      <Route
        path="/update-combo-product-step3/:id"
        element={<ComboProductUpdateStep3 />}
      />
      ...
      <Route
        ...
        element={<SubscriptionChitDetails />}
      />
      <Route path="/scheme" element={<Scheme />} />
      <Route
        path="/subscription-user"
        element={<SubscriptionChitUsersList />}
      />
